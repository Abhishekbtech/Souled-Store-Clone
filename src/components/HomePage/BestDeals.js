...
const BestDeals = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            const response = await axios.get('https://academics.newtonschool.co/api/v1/ecommerce/clothes/products?sort={"price":-1}', {
    ...
    return (
        <div className="products-by-category py-8">
            <h2 className="text-2xl font-bold text-center mb-4 capitalize">Best Deals</h2>
